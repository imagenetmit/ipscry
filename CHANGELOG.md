...
- `--stream-json` for incremental NDJSON event output to stdout during scans,
  with automatic TUI and stderr progress disabled when enabled.

### Changed

- CI and release workflows use `actions/setup-go@v7`.
